...
try: 
	...
	print "Required Python Version is 2.7.x"
	if (pyver[0:3] == '2.7'):
...
try:
	...
	print "Required Opencv version is: 2.4.x"
	if (opencvver[0:3] == '2.4'):
...
try:
	...
	print "Required Numpy version is: 1.8.2"
	if (numpyver == '1.8.2'):
...
# print all_version
hash_version= hashlib.sha224(all_version).hexdigest()
# print hash_version

fo = open("output.csv", "wb")
fo.write(hash_version+","+str(time.time())+","+sysver[3]+"\n");
fo.close
