...
for k in range(1,N_images+1):
	...
	######################your code here###################################
        for i in range(0,6):
                x,y=(550,(i*100)+50)
                if(grid_map[i][5] == 0 or grid_map[i][5] == 1 or grid_map[i][5] == 2 or grid_map[i][5] == 3 or grid_map[i][5] == 4 or grid_map[i][5] == 5 or grid_map[i][5] == 6 or grid_map[i][5] == 7 or
                   grid_map[i][5] == 8 or grid_map[i][5] == 9):
                        cv2.putText(img_rgb, str(grid_map[i][5]), (x-m/4, y+n/4),cv2.FONT_HERSHEY_PLAIN, 5, (0, 0, 255), 4)
                else:
                        cv2.putText(img_rgb, str(grid_map[i][5]), (x-m/2-4, y+n/4),cv2.FONT_HERSHEY_PLAIN, 5, (0, 0, 255), 4)
